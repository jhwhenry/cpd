...
Create an ImageSetConfiguration file `ocp_serveless_416.yaml` for Serverless Knative Eventing as below:
...
```
cd /root/mirroring
oc mirror --config=./ocp_serveless_416.yaml docker://159.33.188.34:8080 --source-skip-tls --dest-skip-tls --verbose 9
```
